// components/use-cases/authentication/AuthenticationHero.tsx
"use client";
import { motion } from "framer-motion";
import Link from "next/link";
import { ArrowRight, Sparkles, Key, Shield, Lock, Smartphone, ChevronRight } from "lucide-react";

export default function AuthenticationHero() {
  const keyPoints = [
    { icon: <Key className="h-4 w-4" />, text: "7 authentication templates" },
    { icon: <Shield className="h-4 w-4" />, text: "Bank-level security" },
    { icon: <Lock className="h-4 w-4" />, text: "99.9% delivery rate" },
    { icon: <Smartphone className="h-4 w-4" />, text: "< 5 second delivery" },
  ];
  ...
  return (
    <section className="relative py-10 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-indigo-50/20 to-violet-50/20" />
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-gray-700 font-medium">Authentication & OTP</span>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                <span className="block text-gray-900">Secure User</span>
              ...
              <p className="text-lg text-gray-600">
                Streamline login, signup, and account verification with secure 
                OTP, magic links, and 2FA. Deliver authentication codes instantly 
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">Login OTP</div>
                        <div className="text-sm text-gray-500">Your code: 492751</div>
                      </div>
                      <div className="ml-auto text-xs text-indigo-600 font-semibold">
                        2.3s delivery
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">2FA Code</div>
                        <div className="text-sm text-gray-500">Verification required</div>
                      </div>
                      <div className="ml-auto text-xs text-indigo-600 font-semibold">
                        Expires: 10min
                      </div>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Click to sign in</div>
                      </div>
                      <div className="ml-auto text-xs text-indigo-600 font-semibold">
                        One-time use
                      </div>
