      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            >
              <span className="block text-gray-900 mb-2">Build the Future of</span>
            ...
            >
              Join Sendexa and help build the communication and payment infrastructure 
              that powers modern businesses worldwide. Work with brilliant minds, 
