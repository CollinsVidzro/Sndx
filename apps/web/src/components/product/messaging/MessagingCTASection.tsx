// components/product/messaging/MessagingCTASection.tsx
"use client";
import { motion } from "framer-motion";
import Link from "next/link";
import { ArrowRight, MessageCircleMore, CheckCircle, Zap } from "lucide-react";

export default function MessagingCTASection() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Start Building with Sendexa Messaging
          </h2>
          
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Join thousands of developers building reliable communication with our Messaging API
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              >
                <div className="text-cyan-600">{benefit.icon}</div>
